...
これは`codex/spike-ephy-reuse-core@c509dfc`の2026-09-13時点の設計記録を保存したものである．常駐版の現在の責任分界は[ADR-0017](ADR-0017-resident-feedback-and-runtime-reuse.md)を優先する．以下の「このworktree」と別画面・ランチャーは旧実験を指し，常駐版へ取り込んでいない．
