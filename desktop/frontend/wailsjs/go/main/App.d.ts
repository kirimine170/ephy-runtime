...
export function GetRecordingStatus():Promise<recording.Status>;
...
export function ReadRecordedConversation(arg1:recording.Target):Promise<recording.ReadResult>;
...
export function SetRecordingConversation(arg1:string):Promise<string>;
